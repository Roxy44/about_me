    ...
    content: [
      {
        ...
        caption: {
          main: locale === 'ru' ? 'Магистр 2021 – 2023' : 'Master 2021 – 2023',
			...
			{
				type: 'paragraph',
				text: locale === 'ru' ? 'Специальность: Программное обеспечение вычислительной техники и автоматизированных систем' : 'Specialty: Software for Computer Technology and Automated Systems',
			},
			{
				type: 'divider',
			},
