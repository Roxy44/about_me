            ...
            content: [
                {
                    ...
                    content: [
                        ...
                        {
                            type: 'paragraph',
                            text: locale === 'ru' ? 'Основные обязанности:' : 'Main responsibilities:',
                        },
                        {
                            type: 'list',
                            dotList: true,
                    ...
                    content: [
                        {
                            ...
                            text:
                                locale === 'ru'
                                    ...
                                    : isMobile
                                      ? 'Mikran'
                                      : 'Mikran, Scientific and Production Company, LLC',
                            caption: {
                        ...
                        },
                        {
                            ...
                            items: [
                                locale === 'ru'
                                    ? 'самостоятельное UI/UX-проектирование и оптимизация пользовательских интерфейсов (в роли единственного Frontend-разработчика)'
                                    : 'independent UI/UX design and optimization of user interfaces (as the only Frontend developer)',
                                locale === 'ru'
                                    ? 'интеграция Frontend с Backend, взаимодействие с тестировщиками, аналитиками, дизайнерами'
                                    : 'integration of Frontend with Backend, interaction with testers, analysts, designers',
                                locale === 'ru'
                                    ? 'поддержка старого кода и переход на новый стек'
                                    : 'support of the old code and transition to the new stack',
                            ],
                        },
                    ],
                },
